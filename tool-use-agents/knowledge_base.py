"""
Same fictional "NorthStar Analytics" knowledge base from the RAG and
context engineering exercises — reused deliberately. Today the search
step becomes a tool Claude decides to call, instead of a fixed pipeline
