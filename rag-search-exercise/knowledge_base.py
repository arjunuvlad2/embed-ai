"""
A small, fictional internal knowledge base for "NorthStar Analytics" — used
to demonstrate retrieval-augmented generation. Ten short policy/process
documents spanning HR, engineering, and IT. Deliberately specific (numbers,
timeframes) so it's obvious whether an answer came from real retrieval or
